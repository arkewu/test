...
class GetSellerEventsRequest extends EbayApiAbstract{
    ...
    /**@var string 是否包含多属性*/
	protected $_includeVariationSpecifics = null;

	/**@var string 是否包含浏览次数*/
	protected $_includeWatchCount = null;

    /**@var 是否为修改时间段内的项目*/
    protected $_newItemFilter = null;
    ...
    public function setRequest(){
        ...
        if (!is_null($this->_includeVariationSpecifics))
            $request['IncludeVariationSpecifics'] = $this->_includeVariationSpecifics ? true : false;
        ...
        if (!is_null($this->_newItemFilter))
            $request['NewItemFilter'] = $this->_newItemFilter ? true : false;
     ...
     */
    public function setIncludeVariationSpecifics($boolean) {
        $this->_includeVariationSpecifics = $boolean;
        return $this;
    }
    ...
    /**
     * @desc 设置是否返回修改时间内的item
     * @param boolean $boolean
     */
    public function setNewItemFilter($boolean) {
        $this->_newItemFilter = $boolean;
        return $this;
    }
